...
#define IC_FIRST_BUTTON_GEOMETRY QRect(0, 80, 78, 48) //メニュー1
...
#define IC_7_GEOMETRY            QRect(0, 128, 78, 48) //7
...
#define IC_HORIZON_FIRST_BUTTON_GEOMETRY QRect(78, 34, 78, 48) //固定値ボタン1
#define IC_HORIZON_7_GEOMETRY            QRect(78, 82, 78, 48) //7
