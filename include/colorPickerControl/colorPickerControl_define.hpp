...
#define CPC_SCREENSIZE                      QSize(312, 520)

#define CPC_TITLE_GEOMETRY                  QRect(0, 0, 312, 32)
#define CPC_BUTTON_XY_GEOMETRY              QRect(0, 32, 78, 48)
#define CPC_BUTTON_RGB_GEOMETRY             QRect(78, 32, 78, 48)
#define CPC_BUTTON_PREVIOUS_TAB_GEOMETRY    QRect(156, 32, 78, 48)
#define CPC_BUTTON_NEXT_TAB_GEOMETRY        QRect(234, 32, 78, 48)
#define CPC_LABEL_SETTING_GEOMETRY          QRect(0, 320, 312, 32)
