...
#define EC_BUTOTN_NEXT_GEOMETRY             QRect(234, 32, 78, 48)

#define EC_LABLE_PARAM_SIZE                 QSize(78, 48)
#define EC_LABEL_PARAM_PLACEMENT_START      QPoint(0, 82)
#define EC_ENCODER_SIZE                     QSize(78, 204)
#define EC_ENCODER_PLACEMENT_START          QPoint(0, 118)

#define EC_MAX_ENCODER_ITEMS                4
#define EC_ENCODER_SPACING                  10
