...
#define LC_HORIZON_LIB_BUTTON_TOP_LEFT   QPoint(78, 82)
#define LC_HORIZON_MODE_TOP_LEFT         QPoint(78, 34)
#define LC_HORIZON_TITLE_GEOMETRY        QRect(78, 2, 780, 32)
#define LC_HORIZON_ALL_GEOMETRY          QRect(78, 34, 78, 48)
#define LC_HORIZON_BUTTON1_GEOMETRY      QRect(78, 82, 78, 48)
...
#endif // LIBRARYCONTROLHORIZON_DEFINE_H
