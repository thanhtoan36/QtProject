...
InputNumPanelControl::InputNumPanelControl(QWidget *parent)  : PanelControlBase(parent),
    m_grid(this),
    m_label_title(this),
...
void InputNumPanelControl::SetDispParamData(INPUT_NUM_DISP_PARAM *param)
{
    Q_ASSERT(param);
...
void InputNumPanelControl::SetupUiComponents()
{
...
void InputNumPanelControl::SetupUiEvents()
{
    connect(this, &InputNumPanelControl::modeChanged, this, &InputNumPanelControl::onModeChanged);
    connect(this, &InputNumPanelControl::typeChanged, this, &InputNumPanelControl::onTypeChanged);
    ...
    connect(this, &InputNumPanelControl::currentButtonModePageChanged, this, &InputNumPanelControl::onCurrentButtonModePageChanged);
    connect(&m_button_mode_255, &QPushButton::clicked, this, &InputNumPanelControl::onButtonMode255Clicked);
    connect(&m_button_mode_angel, &QPushButton::clicked, this, &InputNumPanelControl::onButtonModeAngelClicked);
    connect(&m_button_mode_percent, &QPushButton::clicked, this, &InputNumPanelControl::onButtonModePercentClicked);
    connect(&m_button_relative, &QPushButton::clicked, this, &InputNumPanelControl::onButtonRelativeClicked);
    connect(&m_button_absolute, &QPushButton::clicked, this, &InputNumPanelControl::onButtonAbsoluteClicked);
}

void InputNumPanelControl::onButtonModeColorCheck(const int index, QObject *sender)
{
...
void InputNumPanelControl::onButtonModePositionCheck(const int index, QObject *sender)
{
...
void InputNumPanelControl::onButtonModeGoboCheck(const int index, QObject *sender)
{
...
void InputNumPanelControl::onButtonModeShutterCheck(const int index, QObject *sender)
{
...
void InputNumPanelControl::onButtonModeControlCheck(const int index, QObject *sender)
{
...
void InputNumPanelControl::onModeChanged()
{
...
void InputNumPanelControl::onTypeChanged()
{
...
void InputNumPanelControl::onCurrentButtonModePageChanged()
{
    if (type() == INPUT_NUM_TYPE_COLOR)
    {
...
void InputNumPanelControl::onButtonMode255Clicked(const bool check)
{
    if (check)
    {
...
void InputNumPanelControl::onButtonModeAngelClicked(const bool check)
{
    if (check)
    {
...
void InputNumPanelControl::onButtonModePercentClicked(const bool check)
{
    if (check)
    {
...
void InputNumPanelControl::onButtonRelativeClicked(const bool check)
{
    if (check)
    {
...
void InputNumPanelControl::onButtonAbsoluteClicked(const bool check)
{
    if (check)
    {
...
InputNumMode InputNumPanelControl::mode() const
{
    return m_mode;
}

void InputNumPanelControl::setMode(InputNumMode newMode)
{
    if (m_mode == newMode)
        return;
    m_mode = newMode;
...
InputNumType InputNumPanelControl::type() const
{
    return m_type;
}

void InputNumPanelControl::setType(InputNumType newType)
{
    if (m_type == newType)
        return;
    m_type = newType;
...
int InputNumPanelControl::currentButtonModePage() const
{
    return m_currentButtonModePage;
}

void InputNumPanelControl::setCurrentButtonModePage(int newCurrentButtonModePage)
{
